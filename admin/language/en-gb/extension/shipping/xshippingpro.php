...
$_['entry_disable'] = 'Disable Entire Shipping';
...
$_['text_shipping_disable'] = 'It will make all shipping methods unavailable and display an error message.';
$_['text_disable_other'] = 'It will disable other shipping methods and keep only this method active.';
...
$_['help_store']  = $_['help_zone'] = $_['help_customer_group'] = $_['help_currency'] = $_['help_geo_zone'] = $_['help_country'] = $_['help_payment'] = $_['help_city_all'] = $_['help_postal_all'] = $_['help_coupon_all'] = $_['help_days'] = $_['help_customer_all'] = 'If you want to specify any particular items, please uncheck `For Any` to show the available options';
...
$_['help_partial'] ='It counts partial-block pricing if it is available. For example, if you set the `Per Unit Block` to six, but the customer wants to purchase three units only,  it will charge for a half-block i.e., it will calculate the cost for three units accordingly. If you set the `Allow Partial` to 0, it will always charge the customer for a full-block regardless of the completeness of the block.';
...
$_['help_product_unit_type'] = 'Define how would per unit be calculated';
$_['help_error'] = 'The error message that would show in case of unavailability of all the shipping methods.';
...
$_['help_disable'] = 'You must define an error message to work this option, otherwise, it won\'t work';
$_['help_disable_other'] = 'If several methods use this rule, the first method encountered will prevail over others.';
