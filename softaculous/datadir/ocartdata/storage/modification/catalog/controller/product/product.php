...
';
			...
			//BOF Product Option Image
			if ($this->config->has('product_option_image_product_image_selector'))
			{ 
				$data['product_option_image_product_image_selector'] = html_entity_decode($this->config->get('product_option_image_product_image_selector'));
			}
			else
			{
