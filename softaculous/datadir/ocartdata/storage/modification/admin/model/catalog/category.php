...
$this->db->query("INSERT INTO " . DB_PREFIX . "category_description_seo SET category_id = '" . (int)$category_id . "', language_id = '" . (int)$language_id . "', custom_imgtitle = '" . $this->db->escape($value['custom_imgtitle']) . "', custom_alt = '" . $this->db->escape($value['custom_alt']) . "',  custom_h1 = '" . $this->db->escape($value['custom_h1']) . "', custom_h2 = '" . $this->db->escape($value['custom_h2']) . "'");
...
$this->db->query("DELETE FROM " . DB_PREFIX . "category_description_seo WHERE category_id = '" . (int)$category_id . "'");
