	...
	public function getTotalSEOs($data = array()) {
			...
			$sql = "select count(*) as total from (
				select 'Product' as type, p.product_id  from " . DB_PREFIX . "product p
				  ...
				  left join " . DB_PREFIX . "seo_url u on u.language_id = pd.language_id and CONCAT('product_id=', CAST(p.product_id as CHAR)) = u.query
			...
			$sql.="	  				 				  
				...
				select 'Category' as type,  c.category_id from " . DB_PREFIX . "category c
				  ...
				  left join " . DB_PREFIX . "seo_url u on u.language_id = cd.language_id and CONCAT('category_id=', CAST(c.category_id as CHAR)) = u.query
			...
			$sql .=	"
				...
				select 'Information' as type,  i.information_id from " . DB_PREFIX . "information i
				  ...
				  left join " . DB_PREFIX . "seo_url u on u.language_id = id.language_id and CONCAT('information_id=', CAST(i.information_id as CHAR)) = u.query
			...
			$sql .= "	  
				...
				select 'Manufacturer' as type, m.manufacturer_id from " . DB_PREFIX . "manufacturer m				 
				   left join " . DB_PREFIX . "seo_url u on u.language_id = '" . (int)$this->session->data['language_id'] . "' and CONCAT('manufacturer_id=', CAST(m.manufacturer_id as CHAR)) = u.query WHERE u.store_id = 0 and 1=1";
