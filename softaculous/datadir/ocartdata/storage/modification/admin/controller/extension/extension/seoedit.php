...
$meta_title = $this->db->escape($_POST['meta_title']);
		...
		if (strpos('x'.$id, 'Product') != false)
			...
			if ($keyword<>'') {$query = $this->db->query("insert into " . DB_PREFIX . "seo_url(language_id, query, keyword) values($language_id,'product_id=$id','$keyword');");}
...
$query = $this->db->query("update " . DB_PREFIX . "product_description set meta_title = '$meta_title' where product_id = $id and language_id = $language_id;");
		...
		if (strpos('x'.$id, 'Category') != false)
			...
			if ($keyword<>'') {$query = $this->db->query("insert into " . DB_PREFIX . "seo_url(language_id, query, keyword) values($language_id,'category_id=$id','$keyword');");}
...
$query = $this->db->query("update " . DB_PREFIX . "category_description set meta_title = '$meta_title' where category_id = $id and language_id = $language_id;");
		...
		if (strpos('x'.$id, 'Information') != false)
			...
			if ($keyword<>'') {$query = $this->db->query("insert into " . DB_PREFIX . "seo_url(language_id, query, keyword) values($language_id,'information_id=$id','$keyword');");}
...
$query = $this->db->query("update " . DB_PREFIX . "information_description set meta_title = '$meta_title' where information_id = $id and language_id = $language_id;");
		...
		if (strpos('x'.$id, 'Manufacturer') != false)
			...
			if ($keyword<>'') {$query = $this->db->query("insert into " . DB_PREFIX . "seo_url(language_id, query, keyword) values($language_id,'manufacturer_id=$id','$keyword');");}
